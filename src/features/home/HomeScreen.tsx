/**
 * Tela Inicial (Home)
 * Exibe a lista de módulos disponíveis com layout responsivo.
 */
import { Button, Card, Header } from '@/components';
import { theme } from '@/config/theme';
import { useResponsive } from '@/hooks';
import { getAllModules, getTotalTopicsCount } from '@/services';
...
export function HomeScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="LTP-edu" subtitle="Aprenda Programação do Zero" />
      ...
      >
        ...
        >
          ...
          <Button
            label="Exemplo de Câmera"
            variant="outline"
            onPress={() => router.push('/camera-example')}
            icon={
              <MaterialIcons
                name="photo-camera"
                size={20}
      ...
      <TouchableOpacity
        style={[styles.fab, { backgroundColor: theme.colors.secondary[600] }]}
